...
struct SongApprovalDetailView: View {
    ...
    var body: some View {
            ...
            ZStack(alignment: .top) {
                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("Bu şarkı henüz yayında değil. Lütfen içeriği kontrol edin.")
                            .font(.system(size: 13))
        ...
        .onAppear {
            ...
            // Onay ekranında olduğu için metrikleri ve son çalınanları güncellemiyoruz
